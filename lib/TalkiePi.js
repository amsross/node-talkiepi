...
TalkiePi.prototype.init = function() {
  ...
  this.client.removeListener("error", h.log.bind("talkiepie: error:"));
  this.client.on("error", h.log.bind("talkiepie: error:"));

  this.client.removeListener("disconnect", h.log.bind("talkiepie: disconnect:"));
  this.client.on("disconnect", h.log.bind("talkiepie: disconnect:"));
