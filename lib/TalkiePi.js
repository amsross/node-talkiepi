...
TalkiePi.prototype.init = function() {
  ...
  this.client.removeListener("error", h.log.bind("talkiepi: error:"));
  this.client.on("error", h.log.bind("talkiepi: error:"));

  this.client.removeListener("disconnect", h.log.bind("talkiepi: disconnect:"));
  this.client.on("disconnect", h.log.bind("talkiepi: disconnect:"));
